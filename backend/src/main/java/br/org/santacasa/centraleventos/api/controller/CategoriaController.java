...
public class CategoriaController {
    ...
    public ResponseEntity<CategoriaResponse> criarCategoria(
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(
                categoriaService.criarCategoria(request, resolveUsuario(servletRequest))
        );
    }
    ...
    public CategoriaResponse atualizarCategoria(
        ...
        return categoriaService.atualizarCategoria(id, request, resolveUsuario(servletRequest));
    }
